...
public final class ContactShareQrCodec {
    ...
    public static String toPayload(String trustedSendersCsv) {
    ...
    public static ParsedContactShare fromPayload(String payload) {
        ...
        try {
            ...
            return new ParsedContactShare(obj.optString(FIELD_TRUSTED_SENDERS, ""));
    ...
    public static final class ParsedContactShare {
        ...
        public ParsedContactShare(String trustedSenders) {
