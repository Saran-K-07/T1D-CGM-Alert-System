package com.example.t1dalert.CGM.Repository;
...
import com.example.t1dalert.CGM.Parser.CgmParser;
...
public final class CgmRepository {
    ...
    public CgmRepository(Context context, RequestQueue requestQueue) {
        this(context, requestQueue, new EncryptedPreferencesRepository(context));
    }
